...
function ninethArtist (artistArray, correctedName){

  for(let i = 0; i < artistArray.length; i++ ){
    if(ninethArtist[i] === correctedName){
...
ninethArtist( artistArray, "Vincent Van Gogh")
...
function getArtistByIndex(array, index) {
  ...
  for( i= 0 ; i < array.length ; i++){
    if (getArtistByIndex === index){
      console.log(array(index))
    }
  }
   return getArtistByIndex /* code here */
  }
  
  console.log(getArtistByIndex( 0, name ))
  /**


/* Task 4: Create a function called get20s() that takes data as an argument and returns an array with names of artists who were born in and died in 20th century (1900-2000) example born in 1901 and died in 1959 - included / born in 1889 and died in 1925 not included - should return ["Salvador Dali", "Frida Kahlo"]*/

function get20s(array , years/* Code here */){
