...
Designing your webstie to be accessible to people anybody with a disablitly.

2. Talk about 3 different things you can do to ensure your website is accessible. 

semantic 
default font-size: 62.5% on the whole body
makinng website responsive using rem, em, %


3. How would you explain the concept of a variable to someone new to programming?

a varable is a name the you call through a const, let or var that you asign data too. 

4. What is the purpose of using functions in code?

funtions can run your code mutilple times in different places without retyping it. 
